...
hxd = 0.3*cos(0.1*t);
hyd = 0.3*sin(0.1*t);
hzd = 0.1*sin(0.5*t) + 0.4;

%%%%%%%%%%%%%%%%%%%     VELOCIDAD DESEADA    %%%%%%%%%%%%%%%%
hxdp = -0.3*0.1*sin(0.1*t);
hydp = 0.3*0.1*sin(0.1*t);
hzdp = 0.1*0.5*sin(0.5*t);
...
%b. GRAFICAS
H2 = plot3(hx(1), hy(1), hz(1),'r','LineWidth', 3);
H3 = plot3(hxd, hyd, hzd,'g','LineWidth', 3);
